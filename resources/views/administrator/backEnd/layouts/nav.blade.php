<!--sidebar-menu-->
<div id="sidebar"><a href="{{url('/manage-product')}}" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
    <ul>
        <li{{$menu_active==1? ' class=active':''}}><a href="{{url('/manage-product')}}"><i class="icon icon-home"></i> <span>Dashboard</span></a> </li>
